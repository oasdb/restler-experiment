...
module OASDB
  class IssueInjector
    ...
    API_ISSUES = ["unexpected_payload_root_node"].freeze
...
post '/projects' do
  request.body.rewind
  schema = {"name"=>{"description"=>"The name of the project.", "type"=>"string"}, "description"=>{"description"=>"A meaningful description of the project.", "type"=>"string"}}
...
get '/projects/:project_id' do
  ...
  obj_id = Integer(params['project_id'])
